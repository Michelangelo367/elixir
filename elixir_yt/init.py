...
def _process_cl_args():
    ...
    if args.debug or os.environ.get("elixirdebug") == "1":
        xprint(_get_version_info())
        g.debug_mode = True
        g.no_clear_screen = True

    if args.logging or os.environ.get("elixirlog") == "1" or g.debug_mode:
        logfile = os.path.join(tempfile.gettempdir(), "elixir.log")
...
def _get_version_info():
    ...
    out = "elixir version      : " + __version__
    out += "\n   notes           : " + __notes__
